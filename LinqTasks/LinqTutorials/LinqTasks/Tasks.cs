...
public static partial class Tasks
{
    ...
    {
        return Emps.GroupBy(x => x.Job, (key, g) => new { Praca = key, LiczbaPracownikow = g.Count() });
    ...
    {
        return Emps.Where(x=>x.Job=="Frontend programmer").OrderByDescending(x=>x.HireDate).First();
    }
